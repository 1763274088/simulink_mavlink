/*
DO NOT EDIT.
This file was automatically created by the Matlab function 'create_sfun_encode' on 08-Sep-2018 10:51:41
as part of Simulink MAVLink library.
*/
#define S_FUNCTION_NAME  sfun_encode_msg_set_attitude_target
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    DTypeId BusType;
	ssRegisterTypeFromNamedObject(S, BUS_NAME_SET_ATTITUDE_TARGET, &BusType);
	...
	ssSetOutputPortWidth(S, 0, ENCODED_LEN_SET_ATTITUDE_TARGET);
...
{
	int_T *busInfo = (int_T *) malloc(2*NFIELDS_BUS_SET_ATTITUDE_TARGET*sizeof(int_T));
    if(busInfo == NULL) {
      ssSetErrorStatus(S, "Memory allocation failure");
      return;
    }
	encode_businfo_set_attitude_target(S, busInfo, 0);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
	...
	encode_vector_set_attitude_target(uvec, busInfo, yvec, 0);
}
