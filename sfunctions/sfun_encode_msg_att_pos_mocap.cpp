/*
DO NOT EDIT.
This file was automatically created by the Matlab function 'create_sfun_encode' on 06-Sep-2018 11:02:24
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    DTypeId BusType;
	ssRegisterTypeFromNamedObject(S, BUS_NAME_ATT_POS_MOCAP, &BusType);
	...
	ssSetOutputPortWidth(S, 0, ENCODED_LEN_ATT_POS_MOCAP);
...
{
	int_T *busInfo = (int_T *) malloc(2*NFIELDS_BUS_ATT_POS_MOCAP*sizeof(int_T));
    if(busInfo == NULL) {
      ssSetErrorStatus(S, "Memory allocation failure");
      return;
    }
	encode_businfo_att_pos_mocap(S, busInfo, 0);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
	...
	encode_vector_att_pos_mocap(uvec, busInfo, yvec, 0);
}
