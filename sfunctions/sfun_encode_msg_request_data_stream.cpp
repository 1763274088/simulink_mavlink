/*
DO NOT EDIT.
This file was automatically created by the Matlab function 'create_sfun_encode' on 06-Sep-2018 11:02:26
as part of Simulink MAVLink library.
*/
#define S_FUNCTION_NAME  sfun_encode_msg_request_data_stream
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    DTypeId BusType;
	ssRegisterTypeFromNamedObject(S, BUS_NAME_REQUEST_DATA_STREAM, &BusType);
	...
	ssSetOutputPortWidth(S, 0, ENCODED_LEN_REQUEST_DATA_STREAM);
...
{
	int_T *busInfo = (int_T *) malloc(2*NFIELDS_BUS_REQUEST_DATA_STREAM*sizeof(int_T));
    if(busInfo == NULL) {
      ssSetErrorStatus(S, "Memory allocation failure");
      return;
    }
	encode_businfo_request_data_stream(S, busInfo, 0);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
	...
	encode_vector_request_data_stream(uvec, busInfo, yvec, 0);
}
