...
#include "D:\000_simulink_mavlink-udp-git\simulink_mavlink\include\mavlink\v1.0\common\mavlink_msg_position_target_local_ned.h"
#define BUS_NAME_POSITION_TARGET_LOCAL_NED "mavlink_position_target_local_ned_t"
#define NFIELDS_BUS_POSITION_TARGET_LOCAL_NED 14
#define ENCODED_LEN_POSITION_TARGET_LOCAL_NED (MAVLINK_NUM_NON_PAYLOAD_BYTES + MAVLINK_MSG_ID_POSITION_TARGET_LOCAL_NED_LEN)
...
*/
static inline void encode_businfo_position_target_local_ned(SimStruct *S, int_T *busInfo, const int_T offset)
{
	slDataTypeAccess *dta = ssGetDataTypeAccess(S);
	const char *bpath = ssGetPath(S);
	DTypeId BUSId = ssGetDataTypeId(S, BUS_NAME_POSITION_TARGET_LOCAL_NED);
...
a bitstream.
*/
static inline uint16_t encode_vector_position_target_local_ned(const char *uvec, const int_T *busInfo, uint8_T *yvec, const int_T offset)
{
	mavlink_position_target_local_ned_t ubus;
	...
	mavlink_msg_position_target_local_ned_encode(SYS_ID, COMP_ID, &msg_encoded, &ubus);
...
*/
static inline void decode_msg_position_target_local_ned(const mavlink_message_t* msg_encoded, const int_T *busInfo, char *yvec, const int_T offset)
{
	mavlink_position_target_local_ned_t ybus;
	mavlink_msg_position_target_local_ned_decode(msg_encoded, &ybus);
